...
SECRET_KEY = 'i$h6g84!-g&0edoj)z5cw4@^5sz+evw1c#r*p7z_v-y&8b37=7'
...
INSTALLED_APPS = [
    'main.apps.MainConfig', # add 'main.apps.MainConfig'
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware', # message framework
